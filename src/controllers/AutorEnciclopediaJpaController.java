...
import entitysRecursos.AutorEnciclopedia;
...
public class AutorEnciclopediaJpaController implements Serializable {
    ...
    public void create(AutorEnciclopedia autorEnciclopedia) throws PreexistingEntityException, Exception {
    ...
    public void edit(AutorEnciclopedia autorEnciclopedia) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public List<AutorEnciclopedia> findAutorEnciclopediaEntities() {
        return findAutorEnciclopediaEntities(true, -1, -1);
    }

    public List<AutorEnciclopedia> findAutorEnciclopediaEntities(int maxResults, int firstResult) {
    ...
    public AutorEnciclopedia findAutorEnciclopedia(String id) {
        EntityManager em = getEntityManager();
        try {
    ...
    public int getAutorEnciclopediaCount() {
        EntityManager em = getEntityManager();
        try {
            CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
