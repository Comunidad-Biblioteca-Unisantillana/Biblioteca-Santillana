...
public class CategoriaColeccionJpaController implements Serializable {
    ...
    public CategoriaColeccionJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(CategoriaColeccion categoriaColeccion) throws PreexistingEntityException, Exception {
    ...
    public void edit(CategoriaColeccion categoriaColeccion) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public List<CategoriaColeccion> findCategoriaColeccionEntities(int maxResults, int firstResult) {
    ...
    public int getCategoriaColeccionCount() {
        EntityManager em = getEntityManager();
        try {
            CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
