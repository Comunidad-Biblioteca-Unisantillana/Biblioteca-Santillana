...
@NamedQueries({
    ...
    , @NamedQuery(name = "MultaDiccionarioProfesor.findByFechamulta", query = "SELECT m FROM MultaDiccionarioProfesor m WHERE m.fechamulta = :fechamulta")})
public class MultaDiccionarioProfesor implements Serializable {
    ...
    public MultaDiccionarioProfesor(Integer codmultadicprof, int diasatrasados, int valortotalmulta, String estadocancelacion, String descripcioncancelacion, Date fechamulta) {
        this.codmultadicprof = codmultadicprof;
    ...
    public String toString() {
        return "entitys.MultaDiccionarioProfesor[ codmultadicprof=" + codmultadicprof + " ]";
    }
