...
public class MultaEnciclopediaEstudiante implements Serializable {
    ...
    public MultaEnciclopediaEstudiante(Integer codmultaencest, int diasatrasados, int valortotalmulta, String estadocancelacion) {
        this.codmultaencest = codmultaencest;
    ...
    public String toString() {
        return "entitysRecursos.MultaEnciclopediaEstudiante[ codmultaencest=" + codmultaencest + " ]";
    }
