...
@NamedQueries({
    ...
    , @NamedQuery(name = "MultaLibroEstudiante.findByFechamulta", query = "SELECT m FROM MultaLibroEstudiante m WHERE m.fechamulta = :fechamulta")})
public class MultaLibroEstudiante implements Serializable {
    ...
    public MultaLibroEstudiante(Integer codmultalibroest, int diasatrasados, int valortotalmulta, String estadocancelacion, String descripcioncancelacion, Date fechamulta) {
        this.codmultalibroest = codmultalibroest;
    ...
    public String toString() {
        return "entitys.MultaLibroEstudiante[ codmultalibroest=" + codmultalibroest + " ]";
    }
