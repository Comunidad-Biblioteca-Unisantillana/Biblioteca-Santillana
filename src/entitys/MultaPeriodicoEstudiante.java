...
@NamedQueries({
    ...
    , @NamedQuery(name = "MultaPeriodicoEstudiante.findByFechamulta", query = "SELECT m FROM MultaPeriodicoEstudiante m WHERE m.fechamulta = :fechamulta")})
public class MultaPeriodicoEstudiante implements Serializable {
    ...
    public MultaPeriodicoEstudiante(Integer codmultaperiodicoest, int diasatrasados, int valortotalmulta, String estadocancelacion, String descripcioncancelacion, Date fechamulta) {
        this.codmultaperiodicoest = codmultaperiodicoest;
    ...
    public String toString() {
        return "entitys.MultaPeriodicoEstudiante[ codmultaperiodicoest=" + codmultaperiodicoest + " ]";
    }
