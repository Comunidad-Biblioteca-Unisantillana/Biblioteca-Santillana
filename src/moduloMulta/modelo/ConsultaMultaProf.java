...
public class ConsultaMultaProf extends ConsultaMultaAbs<Multa>{
    ...
    public ObservableList<Multa> getMultasAll() {
        ...
        String sqlSentence = 
                ...
                + " WHERE pd.codPrestDicProf = md.codPrestDicProf AND pd.codBarraDiccionario = d.codBarraDiccionario AND p.idProfesor = pd.idProfesor AND md.estadoCancelacion = 'no pagada' AND table_name = 'diccionario' "
                + " UNION "
                ...
                + " WHERE pe.codPrestEncProf = me.codPrestEncProf AND pe.codBarraEnciclopedia = e.codBarraEnciclopedia AND p.idProfesor = pe.idProfesor AND me.estadoCancelacion = 'no pagada' AND table_name = 'enciclopedia' "
                + " UNION "   
                ...
                + " WHERE pl.codPrestLibroProf = ml.codPrestLibroProf AND pl.codBarraLibro = l.codBarraLibro AND p.idProfesor = pl.idProfesor AND ml.estadoCancelacion = 'no pagada' AND table_name = 'libro' "
                + " UNION "
                ...
                + " WHERE pmapa.codPrestMapaProf = mmapa.codPrestMapaProf AND pmapa.codBarraMapa = mapa.codBarraMapa AND p.idProfesor = pmapa.idProfesor AND mmapa.estadoCancelacion = 'no pagada' AND table_name = 'mapa' "
                + " UNION "
                ...
                + " WHERE pper.codPrestPeriodicoProf = mper.codPrestPeriodicoProf AND pper.codBarraPeriodico = per.codBarraPeriodico AND p.idProfesor = pper.idProfesor AND mper.estadoCancelacion = 'no pagada' AND table_name = 'periodico' "
                + " UNION "
                ...
                + " WHERE pr.codPrestRevistaProf = mr.codPrestRevistaProf AND pr.codBarraRevista = r.codBarraRevista AND p.idProfesor = pr.idProfesor AND mr.estadoCancelacion = 'no pagada' AND table_name = 'revista' "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                multaTmp.setNombreUsuario(rs.getString("nombres") + " " + rs.getString("apellidos"));
            ...
            System.out.println("No se realizo el readAll1 correctamente" + e.getMessage());
        } catch (Exception e) {
    ...
    public ObservableList<Multa> getMultasUsuario(String idUsuario) {
        ...
        String sqlSentences[] = {
            "SELECT md.codMultaDicProf AS codMulta,d.codBarraDiccionario AS codBarra,d.titulo ,md.diasAtrasados,md.valorTotalMulta,md.estadoCancelacion "
                ...
                + "WHERE pd.idProfesor = '" + idUsuario + "' AND pd.codPrestDicProf = md.codPrestDicProf AND pd.codBarraDiccionario = d.codBarraDiccionario AND md.estadoCancelacion = 'no pagada' "
          , "SELECT me.codMultaEncProf AS codMulta,e.codBarraEnciclopedia AS codBarra,e.titulo ,me.diasAtrasados,me.valorTotalMulta,me.estadoCancelacion "
                ...
                + "WHERE pe.idProfesor = '" + idUsuario + "' AND pe.codPrestEncProf = me.codPrestEncProf AND pe.codBarraEnciclopedia = e.codBarraEnciclopedia AND me.estadoCancelacion = 'no pagada'"
          , "SELECT ml.codMultaLibroProf AS codMulta,l.codBarraLibro AS codBarra,l.titulo ,ml.diasAtrasados,ml.valorTotalMulta,ml.estadoCancelacion "
                ...
                + "WHERE pl.idProfesor = '" + idUsuario + "' AND pl.codPrestLibroProf = ml.codPrestLibroProf AND pl.codBarraLibro = l.codBarraLibro AND ml.estadoCancelacion = 'no pagada' "
          , "SELECT mmapa.codMultaMapaProf AS codMulta, mapa.codBarraMapa AS codBarra,mapa.titulo ,mmapa.diasAtrasados,mmapa.valorTotalMulta,mmapa.estadoCancelacion "
                ...
                + "WHERE pmapa.idProfesor = '" + idUsuario + "' AND pmapa.codPrestMapaProf = mmapa.codPrestMapaProf AND pmapa.codBarraMapa = mapa.codBarraMapa AND mmapa.estadoCancelacion = 'no pagada' "
          , "SELECT mper.codMultaPeriodicoProf AS codMulta, per.codBarraPeriodico AS codBarra,per.nombrePeriodico AS titulo ,mper.diasAtrasados,mper.valorTotalMulta,mper.estadoCancelacion "
                ...
                + "WHERE pper.idProfesor = '" + idUsuario + "' AND pper.codPrestPeriodicoProf = mper.codPrestPeriodicoProf AND pper.codBarraPeriodico = per.codBarraPeriodico AND mper.estadoCancelacion = 'no pagada' "
          , "SELECT mr.codMultaRevistaProf AS codMulta, r.codBarraRevista AS codBarra,r.titulo ,mr.diasAtrasados,mr.valorTotalMulta,mr.estadoCancelacion "
                ...
                + "WHERE pr.idProfesor = '" + idUsuario + "' AND pr.codPrestRevistaProf = mr.codPrestRevistaProf AND pr.codBarraRevista = r.codBarraRevista AND mr.estadoCancelacion = 'no pagada'"};
