...
public class ConsultaPrestamoEst extends IConsultarPrestamo{
    ...
    public ObservableList<Prestamo> getHistorialPrestamos(String codEstudiante) {
        ...
        String sqlSentence = "SELECT ple.codBarraLibro AS codBarraRecurso , l.titulo AS titulo, ple.fechaPrestamo, ple.fechaDevolucion, ple.devuelto  \n"
                + "	FROM Prestamo_Libro_Estudiante ple, Libro l\n"
                + "	WHERE ple.codBarraLibro = l.codBarraLibro AND ple.codEstudiante = '" + codEstudiante + "'\n"
                + "UNION \n"
                + "SELECT pee.codBarraEnciclopedia, e.titulo, pee.fechaPrestamo, pee.fechaDevolucion, pee.devuelto \n"
                ...
                + "UNION \n"
                + "SELECT pde.codBarraDiccionario, d.titulo, pde.fechaPrestamo, pde.fechaDevolucion, pde.devuelto \n"
                ...
                + "UNION \n"
                + "SELECT pre.codBarraRevista, r.titulo, pre.fechaPrestamo, pre.fechaDevolucion, pre.devuelto \n"
                ...
                + "UNION \n"
                + "SELECT ppe.codBarraPeriodico, p.nombrePeriodico, ppe.fechaprestamo, ppe.fechaDevolucion, ppe.devuelto \n"
                ...
                + "UNION \n"
                + "SELECT pme.codBarraMapa, m.titulo, pme.fechaprestamo, pme.fechaDevolucion, pme.devuelto \n"
    ...
    public ObservableList<entitys.Prestamo> getPrestamosActuales(String codEstudiante) {
        ...
        String sqlSentence = "SELECT ple.codBarraLibro AS codBarraRecurso , l.titulo AS titulo, ple.fechaPrestamo, ple.fechaDevolucion  \n"
                ...
                + "	FROM Prestamo_Enciclopedia_Estudiante pee, Enciclopedia e\n"
                + "	WHERE WHERE pee.devuelto = 'no' AND pee.codBarraEnciclopedia = e.codBarraEnciclopedia AND pee.codEstudiante = '" + codEstudiante + "'\n"
                + "UNION \n"
