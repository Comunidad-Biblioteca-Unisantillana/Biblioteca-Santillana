...
public class AutorDiccionarioJpaController implements Serializable {
    ...
    /**
     *
     * @param autorDiccionario
     * @throws PreexistingEntityException
     * @throws Exception
     */
    private void create(AutorDiccionario autorDiccionario) throws PreexistingEntityException, Exception {
     ...
     * @throws Exception
     */
    private void edit(AutorDiccionario autorDiccionario) throws IllegalOrphanException, NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
     ...
     * @return
     */
    private List<AutorDiccionario> findAutorDiccionarioEntities() {
     ...
     * @return
     */
    private List<AutorDiccionario> findAutorDiccionarioEntities(int maxResults, int firstResult) {
     ...
     * @return
     */
    private AutorDiccionario findAutorDiccionario(String id) {
        EntityManager em = getEntityManager();
     ...
     * @return
     */
    private int getAutorDiccionarioCount() {
        EntityManager em = getEntityManager();
