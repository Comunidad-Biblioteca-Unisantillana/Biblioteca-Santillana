...
import moduloDevolucion.fabrica.DevolucionDiccionarioEstFab;
 ...
 * @author Felipe
 */
public class DevolucionDiccionarioEstFabTest {

    public DevolucionDiccionarioEstFabTest() {
    }
    ...
    public void testEjecutarDevolucion() {
        ...
        DevolucionDiccionarioEstFab instance = new DevolucionDiccionarioEstFab();
        boolean expResult = true;
        boolean result = instance.ejecutarDevolucion(codBarras, idBibliotecario, estadoRecurso);
        if (result) {
            try {
                //borramos devolucion
                DevolucionDiccionarioDAOEst devolucionDAO = new DevolucionDiccionarioDAOEst();
                List<DevolucionDiccionarioEst> devolucion = devolucionDAO.readAllDAO();
                devolucionDAO.deleteDAO(devolucion.get(devolucion.size() - 1).getCodDevolucionDiccionarioEst());
                ...
                PrestamoDiccionarioDAOEst prestamoDAO = new PrestamoDiccionarioDAOEst();
                List<PrestamoDiccionarioEst> prestamos = prestamoDAO.readAllDAO();
